...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-evidence.OBMWPl/state/ev-scout.status'`
...
# Definition of done
Write your findings to `/tmp/fm-brief-evidence.OBMWPl/data/ev-scout/report.md`.
