...
Both ship and scout scaffolds also carry a compact peer-coordination paragraph that self-gates on a `herdr:` session-context line - inert on backends without one - and leaves firstmate authority and the status-file escalation protocol unchanged.
