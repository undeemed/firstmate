...
# or too old for atomic multi-ID mv (the handoff script refuses < 0.2.2).
...
fm_tasks_axi_compatible || { echo "skip: tasks-axi on PATH lacks atomic multi-ID mv support (0.2.2+ required by the delegated handoff path)"; exit 0; }
