...
SH
  ...
  case "$harness" in
    ...
    pi)
      ...
      cp "$ROOT/.pi/extensions/lib/fm-sessionstart-supervisor.mjs" "$lab/.pi/extensions/lib/"
...
probe_pi_sessionstart_prerequisite() {
  ...
  cp "$ROOT/extensions/lib/fm-operational-input.ts" "$project/extensions/lib/"
  cp "$ROOT/.pi/extensions/lib/fm-sessionstart-supervisor.mjs" "$project/.pi/extensions/lib/"
