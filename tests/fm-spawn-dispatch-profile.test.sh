...
test_no_profile_keeps_claude_profile_defaults() {
  ...
  expected="unset OMPCODE CLAUDECODE; CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION=false claude --dangerously-skip-permissions \"\$('${ROOT}/bin/fm-operational-input.sh' encode launch-brief < '$HOME_DIR/data/$id/brief.md')\""
...
test_active_dispatch_profile_allows_raw_launch_command() {
  ...
  launch=$(cat "$LAUNCH_LOG")
  [ "$launch" = "unset OMPCODE CLAUDECODE; custom-agent --flag" ] || fail "raw launch command changed"$'\n'"actual: $launch"
