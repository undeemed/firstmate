...
SESSION_START_SECOND_MATE_TMP="$FM_TASKTMP_ROOT/fm-$SESSION_START_SECOND_MATE_ID"
SESSION_START_HERDR_SECOND_MATE_ID="fmtest-herdr-${TMP_ROOT##*.}"
SESSION_START_HERDR_SECOND_MATE_TMP="$FM_TASKTMP_ROOT/fm-$SESSION_START_HERDR_SECOND_MATE_ID"
