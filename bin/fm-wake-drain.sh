#!/usr/bin/env bash
# Atomically drain durable watcher wake records, drop records naming a retired
# worker, optionally annotate validated signal status keys after raw consumption
