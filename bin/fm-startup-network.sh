...
phase_label() {  # <phases>
  case "$1" in
    ...
    probe,sweeps) printf 'GitHub authentication, the firstmate instruction refresh, dead-secondmate relaunch, secondmate convergence, pending handoff delivery, and project clone refresh with its drift reporting' ;;
