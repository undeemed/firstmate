...
if [ "$LOCK_RC" -ne 0 ]; then
  ...
  BAR='●━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
  {
    ...
    printf '●  secondmate sync, X-mode artifacts, fleet sync, 3rd-mate sweep, and wake-queue\n'
    printf '●  drain. Detect-only bootstrap diagnostics and the rest of this read-only-safe\n'
