...
#                       sweeps (legacy PR-check migration, firstmate instruction
#                       refresh, secondmate convergence, secondmate liveness,
#                       pending remote handoff retry, X-mode artifact writes,
#                       fleet sync) also run only when locked; the five network
...
#             sync, firstmate instruction refresh, secondmate convergence and
#             liveness, PR-check migration, pending remote handoff retry,
