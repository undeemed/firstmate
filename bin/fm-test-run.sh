...
family_for_basename() {
  case "$1" in
    ...
    fm-herdr-lab.test.sh|fm-lavish-server.test.sh|fm-lint.test.sh|\
    ...
    fm-omp-watch-extension.test.sh|fm-omp-turnend-guard.test.sh|\
    ...
    fm-startup-origin-sync.test.sh|\
    ...
    fm-codegraph-guard-live-e2e.test.sh|\
    fm-codex-continuity-live-e2e.test.sh|fm-grok-continuity-live-e2e.test.sh|\
    fm-cursor-primary-live-e2e.test.sh|fm-desktop-wall-live-e2e.test.sh|\
    ...
    fm-fleet-read.test.sh|fm-fleet-snapshot-view.test.sh|\
    fm-home-summary-refresh.test.sh)
      printf '%s\n' snapshot-bearings
      ;;
...
tests/fm-bearings-board-lavish-live-e2e.test.sh 23865
...
tests/fm-claude-trust.test.sh 11418
tests/fm-cmux-claude-composer-live-e2e.test.sh 23
tests/fm-codegraph-guard-live-e2e.test.sh 465
tests/fm-codegraph-pretool-check.test.sh 5836
...
tests/fm-lavish-poll-channel-live-e2e.test.sh 1911
tests/fm-lavish-server.test.sh 12273
...
tests/fm-nm-test-contract.test.sh 2098
tests/fm-no-mistakes-required.test.sh 370
tests/fm-omp-harness.test.sh 26331
tests/fm-omp-primary-live-e2e.test.sh 1793
tests/fm-omp-turnend-guard.test.sh 2131
tests/fm-omp-watch-extension.test.sh 18334
tests/fm-on.test.sh 11692
tests/fm-opencode-primary-live-e2e.test.sh 21
tests/fm-operational-input.test.sh 231
tests/fm-orphan-sweep.test.sh 5022
...
tests/fm-pi-codex-native.test.sh 2445
...
tests/fm-pr-body-required.test.sh 9258
...
tests/fm-rovo-harness.test.sh 25773
tests/fm-rovo-signals-live-e2e.test.sh 2667
...
tests/fm-secondmate-restart.test.sh 75779
...
tests/fm-spawn-clone-base-drift.test.sh 19020
tests/fm-spawn-dispatch-profile.test.sh 63996
tests/fm-spawn-pool-base-freshen.test.sh 34920
tests/fm-spawn-worktree-collision.test.sh 44019
...
tests/fm-startup-origin-sync.test.sh 39186
tests/fm-stat-shadowing.test.sh 3632
...
tests/fm-treehouse-isolation.test.sh 4714
