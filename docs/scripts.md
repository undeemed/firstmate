...
| `fm-wake-drain.sh`       | Present and acknowledge the current actor's claimed wake rows, dropping records naming a retired worker, alongside status, decision, key-syntax, divergence, recovery, and supervision checks |
