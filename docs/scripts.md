...
| `fm-pr-merge.sh`         | Merge a canonical full GitHub PR URL through the one guard: record task PR metadata, or green-gate a `--pipeline` PR fail-closed and merge pinned to the gated head |
