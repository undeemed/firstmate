...
| `fm-classify-lib.sh`     | Shared wake classification, durable keyed-decision folds and scans, stated-key syntax diagnosis, unread status selection, and bounded latest-event snapshots |
