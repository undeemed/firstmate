...
The watcher absorbs edges naming panes no task meta records, maps the rest back to their tasks, and skips secondmate endpoints and declared `paused:` waits.
