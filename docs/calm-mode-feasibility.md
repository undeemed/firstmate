...
`tests/fm-pi-primary-types.test.sh` performs strict no-emit TypeScript checking of the tracked Pi and omp extensions against the installed Pi declarations, currently package version 0.84.4.
