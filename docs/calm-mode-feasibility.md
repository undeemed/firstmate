...
`tests/fm-pi-primary-types.test.sh` performs strict no-emit TypeScript checking of the tracked Pi and omp extensions against whichever Pi declarations are installed, without pinning a version of its own.
